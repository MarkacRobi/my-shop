            ...
            <div class="row mbr-justify-content-center">
                ...
                <div class="col-lg-6 mbr-col-md-10">
                    <div class="wrap">
                        ...
                        <a href="{{ route('orders.index') }}">
                            <div class="text-wrap vcenter text-muted">
                                <h2 class="mbr-fonts-style mbr-bold mbr-section-title3 display-5">Pregled neobdelanih naročil</h2>
                                <p class="mbr-fonts-style text1 mbr-text display-6">Pregled še neobdelanih naročil in njihovih postavk.</p>
                            </div>
                        </a>
                    </div>
                </div>
                <div class="col-lg-6 mbr-col-md-10">
                    <div class="wrap">
                        ...
                        <a href="{{ route('users.index') }}">
                            <div class="text-wrap vcenter text-muted">
                                <h2 class="mbr-fonts-style mbr-bold mbr-section-title3 display-5">Potrjevanje/Preklic oddanih naročil</h2>
                                <p class="mbr-fonts-style text1 mbr-text display-6">Potrjevanje ali preklic oddanih naročil.</p>
                            </div>
                        </a>
                    </div>
                </div>
